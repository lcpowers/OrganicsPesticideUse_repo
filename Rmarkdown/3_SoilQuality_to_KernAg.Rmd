...
## Put into projection that makes it overlap with Kern Ag and ultimately all spatial data used
soil_sf = spTransform(soil_raw,"+proj=aea +lat_1=29.5 +lat_2=45.5 +lat_0=23 +lon_0=-96 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs") %>%
  st_as_sf() %>%
...
# Check in QGIS
# writeRaster(soil_ras_covered,"../R_output/scratch/na_filled.tif")
