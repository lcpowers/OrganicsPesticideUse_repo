---
title: "Rasterize Soil Quality (Storie Index)"
...
# Set working directory so relative file pathnames are functional.
...
soil_raw = readOGR("../R_input/spatial/KernSoilDataBasin/KernSoilData.shp")
...
## Change soil back into a shapefile. All of this could have been done to the attribute table of a shapefile, but it's nice to be able to easily look at the dataframe as processing is occuring
...
# Apply function from the 4_SoilQuality_to_KernAg.R file to years specified. See notes in function for more details 
for(i in years){
