...
for(i in years){ # For each year...
  ...
  tmp <- readOGR(paste0("../R_output/spatial/KernAg_CDFA_join/",i,"/buffer",j,"/TRSandAPN.shp")) %>% 
  st_as_sf()
...
for(i in years){
  ...
  # Rename the "PMT_SITE" column to "permitsite"
  colnames(tmp_ag)[3] = "permitsite"
  ...
  join_pst = inner_join(tmp_ag,tmp_pst)
...
kernAg_CDFA_pest_2017$HE = kernAg_CDFA_pest_2017$acres*0.405/kernAg_CDFA_pest_2017$N_crops_prmtst
```
...
for(i in years){
  ...
  writeOGR(tmp_shp,
           "../R_output/spatial/KernAg_CDFA_pest/2017/B50/",
           paste0("KernAg_CDFAapnTRS_Pest",i,"_B50"),
