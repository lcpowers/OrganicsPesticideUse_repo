...
input_df = read_stata("../R_input/dta/organicAnalysisPUR copy.dta")
colnames(input_df)
...
common_crops = input_df_fltr$`eval(as.name(comm_colname))`
top5_crops = (head(input_df_fltr$`eval(as.name(comm_colname))`,5))
