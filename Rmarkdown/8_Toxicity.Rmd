...
cas_data<-read_csv("../R_input/CSV/Toxicity/KernChemsUsed1319_Cas.csv") 
casdf<-cas_data %>% 
  filter(!is.na(casnum))
...
cas_tox_df <- list(casdf, AvianDietMallardLC50, AvianDietQuailLC50,
                   FishTroutLC50,FishSunfishLC50,
                   InvertDaphniaLC50,BeeLD50) %>% 
