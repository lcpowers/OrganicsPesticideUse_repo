...
The data being read in with the read_csv() function is from the original CDFA data. Years 2013-2017 were separated by tabs in the same excel (.xls) sheet. Prior to being read in to this Rmarkdown document, each tab was converted into an individual .csv file in Excel because R does not deal with .xls sheets well, especially those with multiple tabs. The same was done with 2017-2019 but separately as the data was received at a later date and in a different format. Data for 2017-2019 was supplied in PDF format, was converted to excel xlsx and then csv format. Will be read in here separate.
