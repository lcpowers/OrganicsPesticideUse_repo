...
comm_regression_df$pscores = predict.glm(propensity_logit,type="response")#CAn you use this equation on this dataset? Equation used other dataset
...
# matches_reg = lm(KgPerHE ~ croptype + cdfa_org + hectares + soil_quality , data = matches_filter)#croptype not defined as variable
matches_reg = lm(KgPerHE ~ comm_edit + cdfa_org + hectares + soil_quality , data = matches_filter)
summary(matches_reg)
