...
for(i in years){
  ...
  # Read in Kern County Ag-CDFA shapefile produced on function above. 
  ...
  ## Read in Kern County Ag data with soil quality in attribute table, produced in RMD 3
  ...
  # Join Kern County Agriculture data to CDFA sections
  ...
  # Create binary column where 1 is assigned to rows where the work "ORGANIC" is in the permittee name, and otherwise 0
  ...
  apn_trs_organics_final = apn_trs_organics_join %>% 
    ...
    # Replace NAs with 0s in the trs_match column to make binary column
...
for(i in years){
  ...
  # Incomment to write intermediate output file
