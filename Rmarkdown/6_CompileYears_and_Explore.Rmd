...
colnames(all_years_df) = c("permitsite","ag_permit","s_status","permittee","comm_original","comm_code","agroclass","genus","family",
                           "comm_edit","acres","soil_quality","apn_org","trsonly_org","trspermittee_org","cdfa_org","kerncomm_org","kernpermittee_org",
                           "all_org","ag_site","year","pur_permit","pur_site","ac_permit","units","n_crops","hectares")
...
colnames(all_years_df) = c("permitsite","permit","s_status","permittee","comm_original","comm_code","agroclass","genus","family",
                           "comm_edit","acres","soil_quality","apn_org","trsOnly_org","trsPermittee_Org","cdfa_org","KernComm_org","KernPermittee_org",
                           "all_org","ag_site","pur_permit","pur_site","year","n_crops","hectares")
