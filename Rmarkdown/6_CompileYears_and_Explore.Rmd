...
#                            "KgAInsectOnly","KgAHerbOnly","KgAFungOnly","AiInsFng","N_crops","hectares","KgAIperHE","KgPRDperHE") #old orer

colnames(all_years_df) = c("permitsite","permit_ag","s_status","permittee","comm_original","comm_code","agroclass","genus","family",
                           "comm_edit","acres","soil_quality","apn_org","trs_only","trs_permitteeOrg","cdfa_org","KernComm_org","KernPermittee_org",
                           "all_org","permit_pur","site_pur","year","n_crops","hectares")
...
colnames(all_years_shp) = c("permitsite","permit_ag","s_status","permittee","comm_original","comm_code","agroclass","genus","family",
                           "comm_edit","acres","soil_quality","apn_org","trs_only","trs_permitteeOrg","cdfa_org","KernComm_org","KernPermittee_org",
                           "all_org","permit_pur","site_pur","year","n_crops","hectares", "geometry")
